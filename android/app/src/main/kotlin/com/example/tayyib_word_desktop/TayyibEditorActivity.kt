    ...
    private fun action(raw:String){
        ...
        try{
            when{
                ...
                n.contains("font") && n.contains("dialog") -> uno(".uno:FontDialog")
                n.contains("font color") -> uno(".uno:Color")
                n.contains("highlight") -> uno(".uno:CharBackColor")
                n.contains("grow font") || n.contains("increase font") -> uno(".uno:Grow")
                n.contains("shrink font") || n.contains("decrease font") -> uno(".uno:Shrink")
                n.contains("clear formatting") -> uno(".uno:DefaultCharStyle")
                n.contains("change case") -> uno(".uno:ChangeCase")

                n.contains("bullets") -> uno(".uno:DefaultBullet")
                n.contains("numbering") -> uno(".uno:DefaultNumbering")
                n.contains("multilevel") -> uno(".uno:OutlineBullet")
                n.contains("decrease indent") -> uno(".uno:DecrementIndent")
                n.contains("increase indent") -> uno(".uno:IncrementIndent")
                n.contains("line spacing") -> uno(".uno:SpacePara1")
                n.contains("shading") -> uno(".uno:BackColor")
                n.contains("borders") -> uno(".uno:BorderDialog")
                n.contains("sort") -> uno(".uno:SortDialog")

                n.contains("normal") && !n.contains("view") -> uno(".uno:DefaultParagraphStyle")
                n.contains("heading 1") -> uno(".uno:Heading1")
                n.contains("heading 2") -> uno(".uno:Heading2")
                n.contains("title") && !n.contains("subtitle") -> uno(".uno:Title")
                n.contains("subtitle") -> uno(".uno:Subtitle")

                n.contains("blank page") -> uno(".uno:InsertPage")
                n.contains("cover page") -> uno(".uno:InsertPage")
                n.contains("table of contents") -> uno(".uno:InsertTOC")
                n.contains("insert caption") -> uno(".uno:InsertCaptionDialog")
                n.contains("cross-reference") -> uno(".uno:InsertReferenceField")
                n.contains("citation") -> uno(".uno:InsertBibliographyField")
                n.contains("bibliography") -> uno(".uno:InsertBibliography")
                n.contains("index") -> uno(".uno:InsertIndexesEntry")
                n.contains("table of authorities") -> uno(".uno:InsertIndexesEntry")

                n.contains("text box") -> uno(".uno:Text")
                n.contains("wordart") -> uno(".uno:FontworkGalleryFloater")
                n.contains("date and time") -> uno(".uno:InsertDateField")
                n.contains("object") -> uno(".uno:InsertObject")
                n.contains("signature") -> uno(".uno:InsertSignatureLine")
                n.contains("symbol") -> uno(".uno:InsertSpecialCharacter")
                n.contains("special character") -> uno(".uno:InsertSpecialCharacter")

                n.contains("margins") -> uno(".uno:PageStyleDialog")
                n.contains("orientation") -> uno(".uno:PageStyleDialog")
                n.contains("size") && n.contains("page") -> uno(".uno:PageStyleDialog")
                n.contains("columns") -> uno(".uno:FormatColumns")
                n.contains("page color") -> uno(".uno:BackgroundColor")
                n.contains("page borders") -> uno(".uno:BorderDialog")
                n.contains("paragraph spacing") -> uno(".uno:ParagraphDialog")
                n.contains("position") -> uno(".uno:ArrangePosition")
                n.contains("wrap text") -> uno(".uno:WrapOff")

                n.contains("table properties") -> uno(".uno:TableDialog")
                n.contains("insert row") -> uno(".uno:InsertRows")
                n.contains("insert column") -> uno(".uno:InsertColumns")
                n.contains("delete row") -> uno(".uno:DeleteRows")
                n.contains("delete column") -> uno(".uno:DeleteColumns")
                n.contains("merge cells") -> uno(".uno:MergeCells")
                n.contains("split cells") -> uno(".uno:SplitCell")
                n.contains("split table") -> uno(".uno:SplitTable")
                n.contains("repeat header") -> uno(".uno:RepeatHeadline")
                n.contains("convert text") -> uno(".uno:ConvertTableText")
                n.contains("sort table") -> uno(".uno:TableSort")

                n.contains("new comment") -> uno(".uno:InsertAnnotation")
                n.contains("delete comment") -> uno(".uno:DeleteComment")
                n.contains("next comment") -> uno(".uno:NextComment")
                n.contains("previous comment") -> uno(".uno:PreviousComment")
                n.contains("track changes") -> uno(".uno:TrackChanges")
                n.contains("compare documents") -> uno(".uno:CompareDocuments")
                n.contains("protect document") -> uno(".uno:Protect")
                n.contains("accept change") -> uno(".uno:AcceptTrackedChange")
                n.contains("reject change") -> uno(".uno:RejectTrackedChange")

                n.contains("zoom") && n.contains("100") -> uno(".uno:Zoom100Percent")
                n.contains("one page") -> uno(".uno:ZoomPage")
                n.contains("page width") -> uno(".uno:ZoomPageWidth")

                n.contains("print preview") -> uno(".uno:PrintPreview")
                n.contains("save all") -> uno(".uno:SaveAll")
                n.contains("close") -> uno(".uno:CloseDoc")
                n.contains("exit") -> uno(".uno:Quit")
                n.contains("select all") -> uno(".uno:SelectAll")
                n.contains("copy") -> uno(".uno:Copy")
                n.contains("cut") -> uno(".uno:Cut")
